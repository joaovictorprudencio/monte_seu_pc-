...
class ComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer" do
    assert_difference("Computer.count") do
      post computers_url, params: { computer: { description: @computer.description, name: @computer.name, string: @computer.string, text: @computer.text, total_price: @computer.total_price } }
    end
  ...
  test "should update computer" do
    patch computer_url(@computer), params: { computer: { description: @computer.description, name: @computer.name, string: @computer.string, text: @computer.text, total_price: @computer.total_price } }
